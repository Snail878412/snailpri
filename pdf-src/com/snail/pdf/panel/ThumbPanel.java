...
public class ThumbPanel extends JPanel implements Runnable, Scrollable, ImageObserver {
	...
	private static final long serialVersionUID = -7907137918328890320L;
	...
	public void pageShown(int pagenum) {
		if (showing != pagenum) {
			...
			if (pagenum >= 0 && getParent() instanceof JViewport) {
				...
				Rectangle r = new Rectangle(xloc[pagenum], y, (images[pagenum] == null ? defaultWidth : images[pagenum].getWidth(null)), lineheight);
