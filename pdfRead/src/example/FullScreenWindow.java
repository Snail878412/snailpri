...
/**
 * A window that takes over the full screen. You can put exactly one JComponent
 * into the window. If there are multiple screens attached to the computer, this
 * class will display buttons on each screen so that the user can select which
 * one receives the full-screen window.
 */
public class FullScreenWindow {
	...
	/**
	 * Whether this FullScreenWindow has been used. Each FullScreenWindow can
	 * only be displayed once.
	 */
	private boolean dead = false;

	/**
	 * Create a full screen window containing a JComponent, and ask the user
	 * which screen they'd like to use if more than one is present.
	 * 
	 * @param part
	 *            the JComponent to display
	 * @param forcechoice
	 *            true if you want force the display of the screen choice
	 *            buttons. If false, buttons will only display if the user
	...
	/**
	 * Create a full screen window containing a JComponent. The user will only
	 * be asked which screen to display on if there are multiple monitors
	 * attached and the user hasn't already made a choice.
	 * 
	 * @param part
	 *            the JComponent to display
	 */
	...
	/**
	 * Close the full screen window. This particular FullScreenWindow object
